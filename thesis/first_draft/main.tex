...
\begin{table}[htbp]
    ...
    \begin{tabular}{@{}l l c c@{}}
        ...
        Ολοκληρωτικό κέρδος & $K_i$ & $0{,}085$ & $0{,}02$ \\
    ...
    \label{tab:pid-gains}
\end{table}
Επειδή η γεωμετρική αντιστάθμιση της επόμενης ενότητας είναι γραμμική ως προς
τη διορθωμένη γωνία, το κέρδος $K_p = 1$ στο pitch αντιστοιχεί σε πλήρη
εξισορρόπηση της μετρούμενης κλίσης. Ο κορεσμός του ολοκληρωτικού όρου
περιορίζει τη μέγιστη συνεισφορά του σε $K_i I_{max}$, δηλαδή περίπου
$3{,}4^\circ$ στο roll και $0{,}8^\circ$ στο pitch.
...
Αρχικά δοκιμάστηκε και δεύτερο στάδιο φιλτραρίσματος, ένας κινητός μέσος όρος
(moving average) 30 δειγμάτων στην έξοδο του βαθυπερατού φίλτρου, με μήκος
παραθύρου όπως στο \cite{mori_study_2022}, όπου χρησιμοποιείται ο ίδιος κινητός
μέσος για την καταστολή των διακυμάνσεων του IMU κατά το βάδισμα trot. Ο
πραγματικός ρυθμός του βρόχου ελέγχου στο υλικό αποδείχθηκε όμως χαμηλότερος
από τον ονομαστικό, περίπου 68~Hz αντί για 100~Hz (διάμεσο βήμα 14,7~ms), οπότε
τα 30 δείγματα αντιστοιχούν σε παράθυρο περίπου 0,44~s και σε καθυστέρηση
ομάδας (group delay) περίπου 0,22~s, επιπλέον της ήδη υπάρχουσας καθυστέρησης
του βαθυπερατού φίλτρου. Η ταλάντωση του σκελετού κατά το βάδισμα trot έχει
κυρίαρχες συχνότητες περίπου 1 έως 2,2~Hz, δηλαδή περίοδο συγκρίσιμη με το
μήκος του παραθύρου. Ο κινητός μέσος εξάλειφε επομένως την ταλάντωση πριν αυτή
φτάσει στον ελεγκτή, με αποτέλεσμα η γεωμετρική διόρθωση να είναι πρακτικά
ανενεργή: η μέση μετατόπιση πέλματος που προέκυπτε ήταν μόλις περίπου 0,5~mm
στο pitch και 2~mm στο roll. Σε ενδιάμεση δοκιμή με παράθυρο 5 δειγμάτων οι
συχνότητες του βαδίσματος εμφανίζονταν και πάλι στο φιλτραρισμένο σήμα. Ο
κινητός μέσος αφαιρέθηκε τελικά εξ ολοκλήρου, καθώς ο συνδυασμός του φίλτρου
σύντηξης με το βαθυπερατό φίλτρο της \eqref{eq:lowpass} αποδείχθηκε αρκετός.

Κατά τη ρύθμιση εντοπίστηκε επίσης σφάλμα προσήμου στην αναδρομή
\eqref{eq:lowpass} για τη γωνία pitch: η υλοποίηση αποθηκευε ως κατάσταση την
τιμή $-s_k$ αντί για $s_k$, με αποτέλεσμα κέρδος μόνιμης κατάστασης περίπου
$-0{,}54$ αντί για $1$ και πόλο στο $-0{,}3$, δηλαδή εναλλαγή προσήμου σε κάθε
δείγμα. Το σφάλμα διορθώθηκε, και η αντιστροφή προσήμου του pitch, που
απαιτείται από τη σύμβαση αξόνων της ενότητας~\ref{sec:coord-frames},
εφαρμόζεται πλέον μόνο στην έξοδο του φίλτρου.
...
το φιλτράρισμα η διακύμανση αυτή μειώνεται σημαντικά και παραμένει κυρίως η
αργή μεταβολή του προσανατολισμού, την οποία και καλείται να διορθώσει ο
ελεγκτής.
...
0,98 και παραμένει φραγμένη σε όλους τους τύπους βαδίσματος. Η στατική
απόκλιση περίπου $-2^\circ$ που παρουσίαζε η προηγούμενη ρύθμιση των κερδών
έχει σχεδόν εξαλειφθεί. Στο roll, η αύξηση του $K_i$ μείωσε τη μέση κλίση στους
μικτούς βηματισμούς από $-7{,}0^\circ$ σε $-2{,}6^\circ$. Οι τυπικές αποκλίσεις
του Πίνακα~\ref{tab:controller-stats} δεν πρέπει να συγκρίνονται απευθείας με
τα γραφήματα του Σχήματος~\ref{fig:controller-response-comparison}: εκείνα
καταγράφηκαν με τον κινητό μέσο όρο των 30 δειγμάτων ακόμα ενεργό, ο οποίος
εξομάλυνε τεχνητά το ίδιο το καταγεγραμμένο σήμα, άρα και την τυπική του
απόκλιση. Η σταδιακή ολίσθηση του roll που παρατηρήθηκε στην ευθύγραμμη δοκιμή
συζητείται ως ανοιχτό ζήτημα στην ενότητα~\ref{sec:limitations}.
...
\begin{itemize}
  ...
  \item Στην ευθύγραμμη δοκιμή του Πίνακα~\ref{tab:controller-stats} το roll
  παρουσιάζει σταδιακή ολίσθηση, από περίπου $-2{,}6^\circ$ σε $-8{,}8^\circ$
  μέσα σε περίπου 10~s, με τον ολοκληρωτικό όρο να αυξάνεται προς την ίδια
  κατεύθυνση μέχρι τον κορεσμό του. Δεν έχει επιβεβαιωθεί αν η αιτία είναι
  αντεστραμμένο πρόσημο διόρθωσης στον άξονα roll ή ολίσθηση (drift) της
  εκτίμησης roll του IMU, οπότε το ζήτημα παραμένει ανοιχτό.
  \item Το σημείο αναφοράς του ελεγκτή δεν είναι σταθερό: η αρχική κλίση
  υπολογίζεται από το επιταχυνσιόμετρο κατά την εκκίνηση (εξίσωση
  \eqref{eq:tilt-acc}), σε όποια στάση βρίσκεται τυχαία το ρομπότ τη στιγμή
  εκείνη, οπότε η μέση κλίση roll διαφέρει από εκτέλεση σε εκτέλεση.
  \item Ο πραγματικός ρυθμός του βρόχου ελέγχου στο υλικό είναι χαμηλότερος
  από τον ονομαστικό: περίπου 68~Hz αντί για 100~Hz.
...
\begin{table}[htbp]
    ...
    \begin{tabular}{@{}l l r@{}}
        ...
        Παράμετρος & Σύμβολο & Τιμή \\
        \midrule
        Συχνότητα βρόχου ελέγχου (ονομαστική) & & 100 Hz \\
        Επιθυμητή γραμμική ταχύτητα & $v$ & 0,12 m/s \\
...
\begin{table}[htbp]
    ...
    \begin{tabular}{@{}l l r@{}}
        ...
        Κέρδη roll & $K_p,\ K_i,\ K_d$ & 0,50; 0,085; 0,05 \\
