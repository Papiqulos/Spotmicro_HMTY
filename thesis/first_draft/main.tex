...
\begin{equation}
\boldsymbol{\eta}[k] = \boldsymbol{\eta}[k-1] +
\kappa\left(\boldsymbol{\eta}^{*} - \boldsymbol{\eta}[k-1]\right),
\qquad \kappa = 0{,}10,
...
Ο δεξιός μοχλός χρησιμοποιείται για την κλίση του σώματος όσο το ρομπότ είναι
...
L1 (αριστερά). Στη στροφή κατά το βάδισμα, με τις σκανδάλες R2 και L2, η γραμμική ταχύτητα
...
ακτίνια. Η μονάδα \texttt{imu\_plotter.py} παράγει γράφημα τριών αξόνων (roll,
pitch, yaw).
